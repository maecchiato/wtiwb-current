    ...
    return(
      <div id = "home-section" className = "row pb-xl-5">
          ...
          <div className = "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <a id = "franchiseebtn" href = "/" className = "btn btn-lg btn-primary mt-md-2 ">BE A FRANCHISEE!</a>
            </span>
          </div>
          <div className = "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <img id = "cloud1" alt = "Waffle Time Clouds" className = "cloud img-fluid float-right" src = {cloud} />
            <img id = "cloud2" alt = "Waffle Time Clouds" className = "cloud img-fluid ml-5 mt-4" src = {cloud} />
            <img className = "img-fluid d-lg-inline d-xl-none d-sm-inline d-xs-inline" src = {waffleplate} alt = "Waffle Time in Plate"/>
